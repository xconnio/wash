...
func uploadFile(session *xconn.Session, keys *wampshell.KeyPair, localFile, remoteFile string) error {
...
func downloadFile(session *xconn.Session, keys *wampshell.KeyPair, remoteFile, localFile string) error {
